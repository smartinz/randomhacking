...
ExtMvc.CustomerFormPanel = Ext.extend(Ext.form.FormPanel, {
	...
	initComponent: function () {
		...
		this.items = [{
			...
			items: [
				new ExtMvc.CustomerListViewContainer({
					title: 'Customers',
				...
				new ExtMvc.OrderListViewContainer({
					title: 'Orders',
					dataProxy: new Ext.data.MemoryProxy({ items: JSON.parse('{"OrderId":10643,"OrderDate":"\/Date(872460000000)\/","RequiredDate":"\/Date(874879200000)\/","ShippedDate":"\/Date(873151200000)\/","Freight":29.4600,"ShipName":"Alfreds Futterkiste","ShipAddress":"Obere Str. 57","ShipCity":"Berlin","ShipRegion":null,"ShipPostalCode":"12209","ShipCountry":"Germany"}') })
				})
			]
		}];
