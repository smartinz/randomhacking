<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryReferenceControl.ascx.cs"
	Inherits="NorthwindWeb.UI.CategoryReferenceControl" %>
<%@ Register Src="~/UI/SearchCategoryControl.ascx" TagName="SearchCategoryControl"
	TagPrefix="SearchCategoryControl" %>
